...
def process_song_file(cur, filepath):
    """
    Reads song_data files, selecting specified data and inserting the data into the 'songs' and 'artists' PostgreSQL tables.
    
    Parameters:
        cur (psycopg2.cursor()): Database cursor.
        filepath (str): Filepath of the file being processed.
    """
    # open song file
...
def process_log_file(cur, filepath):
    """
    Reads log_data files, filtering by the 'NextSong' page. Extracts, transforms, and loads data for three PostgreSQL tables: time, users, and songplays
...
def process_data(cur, conn, filepath, func):
    ...
    Parameters:
        cur (psycopg2.cursor()): Database cursor.
        con (psycopg2.connect()): Connection to the database.
        filepath (str): Filepath of the file being processed.
        func (Python function): Function used to process each log.    
    """
